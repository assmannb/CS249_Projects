...
public class ContainerBoxClassMain
{
    ...
    public static void main( String[] args )
    {
         ...
         * testContainer.addBoxToList( 4, 3 ); testContainer.addBoxToList( 4, 2
         * ); testContainer.addBoxToList( 4, 5 ); testContainer.addBoxToList( 2,
         * 3 ); testContainer.addBoxToList( 2, 4 ); testContainer.addBoxToList(
         * 5, 7 ); testContainer.addBoxToList( 7, 6 );
         * testContainer.addBoxToList( 5, 5 ); testContainer.addBoxToList( 5, 3
         * );
         */
        /*
         * testContainer.addBoxToList( 7, 6 ); testContainer.addBoxToList( 5, 5
         * ); testContainer.addBoxToList( 5, 3 ); testContainer.addBoxToList( 3,
         * 3 ); testContainer.addBoxToList( 4, 3 ); testContainer.addBoxToList(
         * 4, 2 ); testContainer.addBoxToList( 4, 5 );
         * testContainer.addBoxToList( 2, 3 ); testContainer.addBoxToList( 2, 4
         * ); testContainer.addBoxToList( 5, 7 );
         */
