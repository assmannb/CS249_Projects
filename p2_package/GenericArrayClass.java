        ...
        public void runBubbleSort()
            {
                ...
                for (index = 0; index < arraySize; index++)
                    {
                        for (moveIndex = 0; moveIndex < arraySize; moveIndex++)
                            {
                ...
                for (outerIndex = 1; outerIndex < arraySize; outerIndex++)
                    {
                        ...
                        while ((innerIndex > 0) && (outerIndexData.compareTo(innerIndexData) < 0))
                            {
        ...
        public void runSelectionSort()
            {
                ...
                int lastIndexCheck = arraySize;
                for (index = 0; index < lastIndexCheck; index++)
                    {
                        int minValIndex = index;
                        for (innerIndex = index + 1; innerIndex < lastIndexCheck; innerIndex++)
                            {
